...
<body class="relative custom_cursor">
    @if(!$maintenance || $discovery && auth()->user())
        ...
        <!-- Custom Cursor Start -->
        <div
            class="fixed top-0 left-0 w-8 h-8 border border-gray-400 rounded-full pointer-events-none custom_cursor_one">
        </div>
        <div
...
{{--                            <span>{{  __('Mutaman') }}</span>--}}
                    ...
                    <button
                        class="w-12 h-12 bg-white border rounded-full hamburger menu_toggle dark:bg-nightBlack border-platinum dark:border-greyBlack flex-center"
                        type="button"
                ...
                <div
                    ...
                    <button
                        class="absolute flex items-center justify-center text-sm text-white rounded-full w-9 h-9 close-menu top-4 right-4 bg-greyBlack" aria-label="Close Menu">
...
{{--                    </div>--}}
                ...
                <div class="relative mx-auto minfo__contentBox max-w-container xl:max-2xl:max-w-65rem">
                    ...
                    <div data-scroll-index="2" id="service"
                        ...
                        <div class="px-5 py-8 bg-white md:p-8 dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                            <div
                            ...
                            <div class="grid gap-5 md:gap-6 service-card-wrapper sm:grid-cols-2 lg:gap-7 2xl:gap-8">
                                ...
                                <div
                                    ...
                                    <h4 class="mt-5 mb-4 text-xl font-medium text-black dark:text-white xl:text-2xl">
                                        {{  __('CRM (Customer Relationship Management)') }}
                                    </h4>
                                    <p>
{{ __('I design and implement custom CRM systems using frameworks like Laravel/Filament, focusing on automated lead tracking, robust data segmentation, and personalized customer communication workflows to maximize client retention and sales efficiency.') }}                                    </p>
                                </div>
                                <div
                                    class="relative p-5 transition duration-300 border py-7 md:p-7 card-item group border-platinum dark:border-metalBlack rounded-2xl xl:p-8 2xl:p-10 hover:border-theme">
                                    <div
...
{{--                                               class="text-xl font-semibold leading-normal text-black transition-colors dark:text-white line-clamp-2 2xl:text-2xl 2xl:leading-normal hover:text-theme">--}}
