...
<div data-scroll-index="1" id="about"
    ...
    <div class="px-5 py-8 bg-white md:p-8 dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
...
{{--                </a>--}}
            ...
            <ul class="grid mt-4 mb-10 text-sm lg:mt-6 md:grid-cols-2 gap-x-8 gap-y-3">
                <li class="flex items-center">
                    ...
                    <span class="text-black dark:text-white">{{  __('+91 7978217103') }} </span>
                </li>
                <li class="flex items-center">
                    <span class="flex-[0_0_6rem]">{{  __('Email') }}</span>
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">{{  __('sidharthkumarsamal@gmail.com') }}</span>
                </li>
{{--                <li class="flex items-center">--}}
...
{{--                </li>--}}
                <li class="flex items-center">
                    ...
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">{{  __('https://github.com/GHOST117s') }}</span>
                </li>
                <li class="flex items-center">
                    <span class="flex-[0_0_6rem]">{{  __('Languages') }}</span>
                    <span class="flex-[0_0_2rem]">:</span>
                    <span class="text-black dark:text-white">{{  __('English, Hindi') }}</span>
                </li>
            </ul>
